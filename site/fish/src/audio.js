// QUIET WATER's sound bank and music. The synthesis engine — WebAudio setup and
...
// here is everything above the engine in the stack: the bank and the music. A
// shooter wants sharp transients and a driving minor arpeggio; a lake at dawn
// wants soft attacks and a slow pentatonic pad that only lifts as the clock
// runs down, and no amount of parameterising one into the other would have
// been worth the seam.
